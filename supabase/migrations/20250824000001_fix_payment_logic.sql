-- Corrigir a lógica de pagamento parcial para atualizar o saldo_utilizado do cartão

-- Primeiro, vamos criar uma função para atualizar o saldo_utilizado do cartão
CREATE OR REPLACE FUNCTION public.atualizar_saldo_cartao(
    p_cliente_id uuid,
...
AS $$
BEGIN
    -- Atualizar o saldo_utilizado do cartão, diminuindo pelo valor do pagamento
    UPDATE cartoes
    SET saldo_utilizado = GREATEST(0, saldo_utilizado - p_valor_pagamento)
    WHERE cliente_id = p_cliente_id;
END;
$$;

-- Agora vamos corrigir a função registrar_recebimento_parcial
...
BEGIN
    ...
    -- NOVA LÓGICA: Atualizar o saldo_utilizado do cartão
...
-- Também vamos corrigir a função registrar_recebimento para pagamentos completos
